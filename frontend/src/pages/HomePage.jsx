...
function HomePage() {
  return (
    <div className="bg-gradient-to-br via">
        ...
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col ">
              <span className="font-black bg-clip-text text-transparent font-mono tracking-wider  text-xl bg-gradient-to-r from-primary via-secondary to-accent ">
                Talent IQ
              </span>
              <span className="text-xs   -mt-1 text-base-content/60 font-medium">
                Code Together
              </span>
            </div>
          </Link>
